...
class Games:
    ...
    def ans(shelf, req):
        return render(req, 'eru/ans.html', shelf.params)
    ...
    def signup(shelf, req):
        ...
        return render(req, 'eru/signup.html', shelf.params)
    ...
    def login(shelf, req):
        ...
        return render(req, 'eru/login.html', shelf.params)
